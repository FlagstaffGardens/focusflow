...
import type { BodyInit, RequestInit } from 'undici'
import type { LogFunction } from '../plaud/resolver'
...
interface AssemblyAIResult extends TranscriptResult {
...
export async function transcribeWithAssemblyAI(
  ...
  const uploadResponse = await fetch(`${BASE_URL}/upload`, uploadInit)
  ...
  let status: AssemblyAIResult['status'] = 'processing'
  let result: AssemblyAIResult | undefined
